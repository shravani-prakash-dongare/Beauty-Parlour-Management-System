						...
						<div class="card-body">
							<div class="container">
								...
								<div class="container">
									...
									<div class="text-center alert alert-success fs-5">
									...
									%>
									<div class="text-center alert alert-danger fs-5">Something
										Went Wrong on Server.! Try Again</div>
									<%
									}
									%>
									<%
									...
									<table class="table table-striped table-bordered">
										...
										<tr>
											...
											<td><a href="newAptDlt.jsp?id=<%=rs.getInt("id")%>"
												class="btn btn-outline-danger btn-sm"
												onclick="return confirm('Are you sure you want to Delete');">Delete</a>
												<a href="aptacpt.jsp?id=<%=rs.getInt("id")%>"
												class="btn btn-outline-success btn-sm"
												onclick="return confirm('Are you sure you want to Accept');">Accept</a></td>
										</tr>
										<%
										}
										} catch (Exception e) {
