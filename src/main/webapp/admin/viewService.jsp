						...
						<div class="card-body">
							<div class="container">
								...
								<div class="container">
									...
									%>
									<div class="text-center alert alert-danger fs-5">
										Something Went Wrong on Server.! Try Again</div>
									<%
									}
									%>
									<%
									...
									<table class="table table-striped table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="deleteservice.jsp?id=<%=rs.getInt("id")%>"
